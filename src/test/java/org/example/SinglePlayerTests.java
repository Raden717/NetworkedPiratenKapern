...
class Tests {
    ...
    void Test117(){
        ...
        test.setSwordsSea(2);
        test.roll();
        String[] forcedRoll = {"MONKEY","MONKEY","MONKEY","COIN","PARROT","PARROT","SWORD","SWORD"};
        test.setForceDice(forcedRoll);
        test.updateAlive();
        test.updateScore();
        assertEquals(500, test.getScore());
    ...
    void Test119(){
        ...
        test.setSwordsSea(2);
        test.roll();
        String[] forcedRoll = {"MONKEY","MONKEY","MONKEY","MONKEY","SWORD","SKULL","PARROT","PARROT"};
        test.setForceDice(forcedRoll);
        test.reroll();
        String[] forcedReroll = {"MONKEY","MONKEY","MONKEY","MONKEY","SWORD","SKULL","SWORD","SKULL"};
        test.setForceDice(forcedReroll);
        test.updateAlive();
        test.updateScore();
        assertEquals(500, test.getScore());
    ...
    void Test122(){
        ...
        test.setSwordsSea(3);
        test.roll();
        String[] forcedRoll = {"MONKEY","MONKEY","MONKEY","MONKEY","SWORD","SWORD","SKULL","SKULL"};
        test.setForceDice(forcedRoll);
        test.reroll();
        String[] forcedReroll = {"SKULL","SKULL","SWORD","SWORD","SWORD","SKULL","SWORD","SKULL"};
        test.setForceDice(forcedReroll);
        test.updateAlive();
        test.updateScore();
        assertEquals(0, test.getScore());
